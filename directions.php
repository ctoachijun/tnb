  ...
  <div class="dinner">
    ...
    <div>
      ...
      <div class="dbox">
        ...
        <div class="dinfo">
          <div class="dinfo2">
            <div><img src="./img/icon01.png" alt="위치"> 경남 창녕군 대합면 대합산업단지로 136-5</div>
            <div><img src="./img/icon02.png" alt="전화">055-532-3115</div>
            <div><img src="./img/icon03.png" alt="팩스">055-532-3114</div>
            <div><img src="./img/icon04.png" alt="메일">tnbwood@nate.com</div>
          </div><!-- dinfo2 -->
        </div><!-- dinfo -->
      </div><!-- dbox -->
    </div>
