...
<div class="pvcont">
  ...
  <div class="pvtop">
    ...
    <ul>
      ...
      <li><a ><?=$c1_name_en?></a></li>
      <li><a >Series Number</a></li>
...
<?              endforeach; ?>                
            ...
            <tr>
              <th class="pvdan">Sectional view</th>
              <td class="pvdan">
  ...
  <div class="pvbtn">
      <div class="pvbtn_in">
        <button type="button"><img src="/img/btn_icon.png" alt="button" onclick='pageBack()'>Back</button>
      </div><!-- pvbtn_in -->
  </div><!-- pvbtn -->
</div><!-- pvcont -->
