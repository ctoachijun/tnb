...
$cate1_sel = setCateSel($cate1,"en");
$cate2_sel = setCate2Sel($cate1,$cate2,"en");


// 아이템 영역 세팅
$item_html = setItemHtml($cate1,$cate2,$start,$end,$cur_page,$sw,"en");
        ...
        <div class="pbox">
            ...
            <div class="psearch">
              <div class="psi">
                ...
                <div class="sb"><img src="/img/sb.jpg" alt="search" onclick="goSearch()"></div>
              </div><!-- psi -->
            </div><!-- search -->
        </div><!-- pbox -->
